                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        ...
                        <div class="d-flex position-relative overflow-hidden flex-column p-3 mb-3 bg-white shadow-sm rounded">
                            ...
                            <div class="d-flex">
                                <div>
                                    <img class="d-block rounded-circle" width="32" src="{{asset('public/backend/assets')}}/dist/img/avatar-5.jpg">
                                </div>
                                <div class="pl-3">
                                    Nothing bad to say<br/> at this point 😌
                                    <a class="d-block mt-1 small opacity-75" href="cdn-cgi/l/email-protection.html#c0a8a5b2ada1aeb3b4a1b2a9abafb680a7ada1a9aceea3afad">Write back</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Melissa Ayre">
                                                <img src="{{asset('public/backend/assets')}}/dist/img/avatar-1.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Karen Robinson">
                                                <img src="{{asset('public/backend/assets')}}/dist/img/avatar-2.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Miyah Myles">
                                                <img src="{{asset('public/backend/assets')}}/dist/img/avatar-3.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Daniela Dewitt">
                                                <img src="{{asset('public/backend/assets')}}/dist/img/avatar-4.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </td>
                                    <td>Naeem Khan</td>
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-group">
                                            ...
                                            <a href="user_profile.html" class="avatar avatar-xs" data-toggle="tooltip" title="Daniela Dewitt">
                                                <img src="{{asset('public/backend/assets')}}/dist/img/avatar-5.jpg" class="avatar-img rounded-circle" alt="...">
                                            </a>
                                        </div>
                                    </td>
